...
1. Uma imagem do produto, com opção para visualizar outras imagens do mesmo produto;
2. O nome, o valor, a descrição, e as especificações do produto;
3. Uma lista de produtos relacionados apresentando uma imagem, o nome e o valor dos produtos;
4. Uma lista de comentários de outros usuários apresentando o nome, a data e o comentário.
